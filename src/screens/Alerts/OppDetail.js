...
export default function OppDetail({ navigation }) {
    // constructor(props) {
    //     super(props)
    ...
    return (
        <SafeAreaView>
            <View style={{ paddingTop: 20, width: windowWidth * 0.9, height: windowHeight * 0.85, alignSelf: "center", backgroundColor: '#e8e8e8' }}>
                <View style={{ padding: 5, flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "black" }}>


                    <Text style={{ fontSize: 24, paddingHorizontal: 5, paddingBottom: 20, fontWeight: "bold" }}> Technical Quice Compition By Government Polytechnic Aurangabad </Text>
                </View>
                <ScrollView>
                    <Text style={{ fontSize: 18, paddingBottom: 30 }}> Technical Quice Compition By Government Polytechnic Aurangabad Held On 20/2/5201
                    </Text>
                    <Text style={{ fontSize: 18 }}>
                        Infosys Eligibility Criteria 2020- 2021
